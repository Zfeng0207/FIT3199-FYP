...
vitals_data_path = os.path.join(
    os.path.dirname(__file__), '..', 'stroke_data', 'vitals_data.csv'
)
vitals_data_path = os.path.normpath(vitals_data_path)

vitals_data = pd.read_csv(vitals_data_path)
...
def generate_patient_ecg_plot_html(msg: str) -> Response:
    ...
    # Load vital data
    vital_data_path = os.path.normpath(
        os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'stroke_data', 'vitals_data.csv')
    )
    ...
    ecg_data_path = os.path.normpath(
    os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'stroke_data', 'ecg_data.npy'))
